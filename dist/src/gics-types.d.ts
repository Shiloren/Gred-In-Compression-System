 ...
 */
export declare const GICS_VERSION = "1.1.0";
export declare const GICS_VERSION_1_1 = 17;
/**
 ...
 */
export declare const DEFAULT_ROTATION_POLICY: FileRotationPolicy;
/**
 ...
 */
export type EncodingStrategy = 'delta' | 'delta-of-delta' | 'rle' | 'varint' | 'raw';
/**
 * Bit-pack type for adaptive encoding
 */
export declare enum BitPackType {
 ...
 */
export declare const GICS_MAX_CHANGES_PER_SNAPSHOT = 1000000;
export declare const GICS_MAX_REMOVED_PER_SNAPSHOT = 500000;
/**
 * Block Types for GICS v1.0 Structure
 */
export declare enum BlockType {
    DATA = 1,// Standard compressed data
    INDEX = 2,// Table of Contents (TOC)
    CHECKPOINT = 3
}
/**
